...
Run only operation `fe`. Resolve action before writes. Safe defaults are read-only; capabilities assist without choosing the action or creating write intent. Before conditional discipline, read exactly:
