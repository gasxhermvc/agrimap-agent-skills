---
name: agm-qa
description: Run independent verification-only QA over product artifacts. Use when the requester invokes this AgriMap alias.
---

Run operation `qa` through the compact progressive-disclosure path. Read exactly these files relative to this alias before routing any conditional discipline:
