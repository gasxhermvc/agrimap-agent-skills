...
Run operation `plan` through the compact progressive-disclosure path. Read exactly these files relative to this alias before routing any conditional discipline:

1. `../agrimap-agent-skills/references/runtime-core.md`
2. `../agrimap-agent-skills/references/glossary.md`
3. `../agrimap-agent-skills/references/operations/plan.md`
