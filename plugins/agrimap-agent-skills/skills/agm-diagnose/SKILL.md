...
Run operation `diagnose` through the compact progressive-disclosure path. Read exactly these files relative to this alias before routing any conditional discipline:
