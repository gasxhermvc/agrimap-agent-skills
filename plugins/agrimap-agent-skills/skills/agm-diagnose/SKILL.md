...
Run only operation `diagnose` through its compact progressive-disclosure path. Read exactly these files relative to this skill before loading any conditional discipline:

1. `../agrimap-agent-skills/references/runtime-core.md`
2. `../agrimap-agent-skills/references/glossary.md`
3. `../agrimap-agent-skills/references/operations/diagnose.md`
