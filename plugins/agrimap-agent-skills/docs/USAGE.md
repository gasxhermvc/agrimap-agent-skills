...
| `checklist.md` | `contract`<br>agm-create-prompt initializes acceptance items; executor and leader update status | `standard`<br>`regulated` | `checklist.md` | Checked completion ledger derived from the task contract. | — | — |
