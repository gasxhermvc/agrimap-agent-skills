...
EXEC sys.sp_addextendedproperty
    @name=N'MS_Description', @value=N'รหัส ID ของ Notification Message (Auto Increment)' , @level0type=N'SCHEMA',@level0name=N'agrimap_app', @level1type=N'TABLE',@level1name=N'NOTIFICATION_MESSAGE', @level2type=N'COLUMN',@level2name=N'ID';
GO
EXEC sys.sp_addextendedproperty
    @name=N'MS_Description', @value=N'FK -> NOTIFICATION_TEMPLATE: Template ที่ใช้สร้าง Message' , @level0type=N'SCHEMA',@level0name=N'agrimap_app', @level1type=N'TABLE',@level1name=N'NOTIFICATION_MESSAGE', @level2type=N'COLUMN',@level2name=N'TEMPLATE_ID';
GO
EXEC sys.sp_addextendedproperty
    @name=N'MS_Description', @value=N'FK -> LUT_NOTI_MESSAGE_STATUS: สถานะ (Created, Processing, Done, Failed)' , @level0type=N'SCHEMA',@level0name=N'agrimap_app', @level1type=N'TABLE',@level1name=N'NOTIFICATION_MESSAGE', @level2type=N'COLUMN',@level2name=N'STATUS_ID';
GO
EXEC sys.sp_addextendedproperty
    @name=N'MS_Description', @value=N'FK -> LUT_NOTI_PRIORITY: ระดับความสำคัญ (Low, Normal, High, Urgent)' , @level0type=N'SCHEMA',@level0name=N'agrimap_app', @level1type=N'TABLE',@level1name=N'NOTIFICATION_MESSAGE', @level2type=N'COLUMN',@level2name=N'PRIORITY_ID';
GO
EXEC sys.sp_addextendedproperty
    @name=N'MS_Description', @value=N'FK -> LUT_NOTI_CREATE_SOURCE: แหล่งที่มา (User Management, Data Management)' , @level0type=N'SCHEMA',@level0name=N'agrimap_app', @level1type=N'TABLE',@level1name=N'NOTIFICATION_MESSAGE', @level2type=N'COLUMN',@level2name=N'CREATE_SOURCE_ID';
GO
EXEC sys.sp_addextendedproperty
    @name=N'MS_Description', @value=N'FK -> LUT_NOTI_CREATE_TYPE: ประเภทผู้สร้าง (User, System, Schedule)' , @level0type=N'SCHEMA',@level0name=N'agrimap_app', @level1type=N'TABLE',@level1name=N'NOTIFICATION_MESSAGE', @level2type=N'COLUMN',@level2name=N'CREATE_TYPE_ID';
GO
EXEC sys.sp_addextendedproperty
    @name=N'MS_Description', @value=N'0 = ปกติ, 1 = ลบแล้ว (Soft Delete)' , @level0type=N'SCHEMA',@level0name=N'agrimap_app', @level1type=N'TABLE',@level1name=N'NOTIFICATION_MESSAGE', @level2type=N'COLUMN',@level2name=N'DEL_FLAG';
GO
