...
- `memory/current/<task-id>.md`: only facts required to continue that active task. Update after each glossary-defined checkpoint unit so concurrent tasks do not overwrite each other.
